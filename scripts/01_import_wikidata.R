...
# Define the SPARQL query (for the Wikidata Query Service API) which returns all Canadian Politicians
query <-
...
# Save the dataset
write_csv(x = wiki_data_raw, file = "/Users/ethansansom/Desktop/wiki_data_raw.csv")